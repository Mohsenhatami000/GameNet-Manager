    ...
    , ui(new Ui::MainWindow)
{
    ...
    productCatalog->addProduct(Product(QString("کیک"), 35000));
    productCatalog->addProduct(Product(QString("آبمیوه"), 58000));
    productCatalog->addProduct(Product(QString("بیسکویت"), 55000));
